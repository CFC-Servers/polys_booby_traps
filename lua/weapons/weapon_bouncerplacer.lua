...
SWEP.VElements = {
    ["mine"] = {
        ...
        bone = "v_weapon.c4",
        rel = "",
        pos = Vector( -2.449, 0.565, -1.594 ),
        angle = Angle( -80.414, 167.371, -12.018 ),
...
SWEP.WElements = {
    ...
    ["mine"] = {
        ...
        bone = "ValveBiped.Bip01_R_Hand",
        rel = "",
        pos = Vector( 3.316, 2.582, -0.047 ),
        angle = Angle( 180, -97.172, 2.217 ),
        size = Vector( 1.2, 1.2, 1.2 ),
        color = Color( 255, 255, 255, 255 ),
        surpresslightning = false,
        material = "models/props_vents/borealis_vent001c",
